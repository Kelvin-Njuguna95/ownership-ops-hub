...
A JSON-file polling app that watches Impact Outsourcing's Vessel Ownership QA operation in Airtable base `REDACTED_BASE_ID`, table `relations_support`. Five teams: TEAM_1, TEAM_5, TEAM_4, TEAM_3, TEAM_2. Polls every 15 min between 06:00 and 22:59 EAT.
