...
The working table is `relations_support` in base `REDACTED_BASE_ID`. Each row is one (IMO × Role). Roles are: Registered Owner, Beneficial Owner, Management/Ship Manager, Technical Manager, Operator, Commercial Controller/Charterer, ISM Manager.
