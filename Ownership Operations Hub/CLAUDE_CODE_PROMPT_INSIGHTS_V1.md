...
**Important context.** This is an Airtable-backed dashboard for Impact Outsourcing's Vessel Ownership QA operation. The single source of truth is Airtable base `REDACTED_BASE_ID`, table `relations_support` (`tblpj9aJP4ExhYCZF`). Five teams in scope: Simba, Tembo, Pweza, Kobe, Nyati. Do not touch other teams.
